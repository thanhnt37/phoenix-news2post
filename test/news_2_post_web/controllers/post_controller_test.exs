defmodule News2PostWeb.PostControllerTest do
  use News2PostWeb.ConnCase

  import News2Post.CRUDFixtures

  @create_attrs %{status: "some status", title: "some title", url: "some url", preamble: "some preamble", sections: "some sections"}
